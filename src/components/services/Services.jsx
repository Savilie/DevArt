        ...
        <div className='services__inner'>
          ...
          <div className="services-description">
            <div className='services-description__item'>
              ...
              <p>Отличается от дополненной реальности&nbsp(AR) тем, что видимая действительность искусственна. Пользователю предлагают полное погружение, задействуя дополнительные органы чувств. Мы внедряем новейшие разработки&nbspVR — используем не только шлем, а ещё перчатки, костюмы и контроллеры движения.</p>
            </div>
            <div className='services-description__item'>
